/*
 *  程序名: syncincrementexex_oracle.cpp, 本程序是数据中心的公共功能模块，采用增量的方法同步Oracle数据库之间的表
 *  注意: 本程序不使用database link
 *  作者: ZEL
 */
#include "_public.h"
