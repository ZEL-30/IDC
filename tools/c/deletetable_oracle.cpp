/*
 *  程序名: deletetable_oracle.cpp, 本程序出数据中心的公共功能模块, 用于定时清理表中的数据
 *  作者: ZEL
 */
#include "_public.h"
#include "_ooci.h"
...
connection     conn;         // 用于执行查询和删除的SQL语句的数据库连接 
